            ...
            <div className="dashboard-container">
                <div className="dashboard-header">
                    ...
                    <div className="header-actions">
                        <button className="btn-secondary" onClick={() => navigate('/lawyer-profile')}>
                            Edit Profile
                        </button>
                ...
                <div className="dashboard-features">
                    {features.map((f, i) => (
                        <div key={i} className="feature-card" onClick={() => navigate(f.path)} style={{ '--card-color-1': f.color1, '--card-color-2': f.color2 }}>
