    ...
    const Sidebar = () => (
        <div className="quiz-sidebar">
            ...
            <div className="quiz-sidebar-section">
                <h4>Navigation</h4>
                <div className="quiz-nav-item" onClick={() => navigate('/student-dashboard')}>🏠 Dashboard</div>
                <div className="quiz-nav-item" onClick={() => navigate('/student-notes')}>📁 My Notes</div>
                <div className="quiz-nav-item active">🧠 Quiz</div>
                <div className="quiz-nav-item" onClick={() => navigate('/student-library')}>📖 Resource Hub</div>
                <div className="quiz-nav-item" onClick={() => navigate('/student-learning')}>🎓 Learning</div>
            </div>
            <div className="quiz-sidebar-section">
                <h4>Quiz Steps</h4>
            ...
            <div className="quiz-page">
                ...
                <div className="quiz-main">
                    <div className="quiz-page-header">
                        ...
                        <p>Generate AI-powered quizzes from your own uploaded study notes.</p>
                    </div>

                    <div className="quiz-cta-card">
                        <div>
                            <h2>Ready to test yourself?</h2>
                            <p>Our AI analyzes your uploaded notes and creates personalized MCQs, short answer and long answer questions.</p>
            ...
            <div className="quiz-page">
                ...
                <div className="quiz-main">
                    <div className="quiz-page-header">
                        ...
                        <h1>Select a Note</h1>
                        <p>Choose from your uploaded notes. The AI will generate a tailored quiz.</p>
                    </div>
                    ...
                    {loadingNotes ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '80px', background: 'white', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
                            ...
                            <button onClick={() => navigate('/student-notes')} style={{ padding: '12px 28px', background: '#f57c00', color: 'white', border: 'none', borderRadius: '12px', cursor: 'pointer', fontWeight: '700', fontSize: '0.95rem' }}>Go to My Notes</button>
                        </div>
                    ) : (
                        <>
            ...
            <div className="quiz-page">
                ...
                <div className="quiz-main" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div className="quiz-generating">
                        ...
                        <p>Analyzing <strong>{selectedNote?.title}</strong> and building questions.</p>
            ...
            <div className="quiz-page">
                ...
                <div className="quiz-main">
                    {submitted && (
                        <div className="quiz-score-banner">
                            ...
                            <div>
                                ...
                                <p>Review the Professor's Insights below for descriptive questions.</p>
                            </div>
                    ...
                    <div className="quiz-header-card">
                        <h1>{quiz.title}</h1>
                        <p>{quiz.questions.length} questions — MCQs, Short & Long Answers</p>
                    </div>
                            ...
                            <div key={idx} className="question-card">
                                ...
                                {(q.type === 'short' || q.type === 'long') && (
                                    <textarea
                                        ...
                                        style={{ minHeight: q.type === 'long' ? '180px' : '95px' }}
                                    />
                                )}

                                {submitted && q.explanation && (
                                    <div className="professor-insight">
                                        <strong>Professor's Insight:</strong>
                                        <p>{q.explanation}</p>
                                    </div>
                                )}
                            </div>
