...
const LawyerCaseHistoryPage = () => {
    ...
    const handleMarkComplete = async (caseId, stageId) => {
        try {
            ...
            if (data.success) {
                ...
                fetchCases();
                // If the currently viewed case is this one, update it too
    ...
    const handleAddDeadline = async (e) => {
        ...
        try {
            ...
            const data = await authService.updateCase(selectedCase.id, { deadlines: updatedDeadlines });
            if (data.success) {
                setSelectedCase(data.case);
    ...
    return (
        <div className="case-history-body">
            <div className="case-history-container">
                <Link to="/lawyer-dashboard" style={{ color: '#fff', fontWeight: '700', textDecoration: 'none', marginBottom: '20px', display: 'inline-block' }}>← Back to Dashboard</Link>
                            ...
                            <div key={c._id} className="case-card">
                                ...
                                <div className="case-stats-grid">
                                    <div className="case-stat-item">
                                        ...
                                        <span className="case-stat-value">{c.clientName}</span>
                                    </div>
                                    <div className="case-stat-item">
                                                ...
                                                <div className="timeline-content" style={{ opacity: isCompleted ? 1 : 0.6 }}>
                                                    ...
                                                    {isCurrent && stage.id < 9 && (
                                                        <button
                                                            ...
                                                            onClick={() => handleMarkComplete(selectedCase.id, stage.id + 1)}
