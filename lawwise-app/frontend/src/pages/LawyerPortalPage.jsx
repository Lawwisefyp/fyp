...
const LawyerPortalPage = () => {
    ...
    const handleResendVerification = async (email) => {
        try {
            const result = await authService.resendVerification(email, 'lawyer');
            showAlert(result.message, 'success');
        } catch (error) {
    ...
    const handleForgotPassword = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await authService.forgotPassword(loginData.email, 'lawyer');
    ...
    const handleVerifyOTP = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await authService.verifyOTP(loginData.email, registerData.otp, 'lawyer');
            showAlert(res.message, 'success');
            setView('reset');
        } catch (error) {
    ...
    const handleResetPassword = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await authService.resetPassword(loginData.email, registerData.otp, registerData.password, 'lawyer');
            showAlert(res.message, 'success');
